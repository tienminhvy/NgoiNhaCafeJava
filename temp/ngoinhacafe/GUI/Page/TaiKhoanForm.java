 ...
 * @author ODL
 */
public class TaiKhoanForm extends javax.swing.JPanel implements ActionListener {
    ...
    public TaiKhoanForm() {
        initComponents();
        addActionPerform();
        tkTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    ...
    private void initComponents() {
        ...
        tkTableContainer = new javax.swing.JScrollPane();
        ...
        tkTableContainer.setToolTipText("");
        ...
        tkTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã tài khoản", "Tên tài khoản", "Mật khẩu", "Mã quyền"
            }
        ) {
        ...
        tkTableContainer.setViewportView(tkTable);

        timkiemContainer.setBorder(javax.swing.BorderFactory.createTitledBorder("Tìm kiếm"));

        timKiemTheo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Mã tài khoản", "Tên tài khoản", "Mã quyền" }));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(timkiemContainer, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tkTableContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 560, Short.MAX_VALUE))
        );
    ...
    private javax.swing.JScrollPane tkTableContainer;
    private javax.swing.JButton xoaBtn;
    // End of variables declaration//GEN-END:variables

    TableHandler tbHandler = new TableHandler();
    
    ThemSuaTaiKhoanForm fThemSua = null;
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == themBtn) {
            fThemSua = new ThemSuaTaiKhoanForm("Thêm", "");
        ...
        } else if (tkTable.getSelectedRow() == -1) {
            ThongBao.hienLoi("Vui lòng chọn khách hàng để thực hiện thao tác!");
            return;
        } else {
            DefaultTableModel model = tbHandler.getTableModel(tkTable);
            ...
            if (e.getSource() == suaBtn) {
                fThemSua = new ThemSuaTaiKhoanForm("Sửa",Integer.toString(maTK) );
            }
