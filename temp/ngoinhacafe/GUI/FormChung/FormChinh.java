...
import ngoinhacafe.GUI.FormQuanLy.NhapHangForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLyNhaCungCapForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLyHoaDonForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLySanPhamForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLyKhachHangForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLyKhuyenMaiForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLyLoaiSanPhamForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLyNhanVienForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLyPhieuNhapForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLyQuyenForm;
import ngoinhacafe.GUI.FormQuanLy.QuanLyTaiKhoanForm;
import ngoinhacafe.GUI.FormQuanLy.ThongKe.ThongKeForm;
import ngoinhacafe.GUI.NavBar.NavBarButton;
import ngoinhacafe.GUI.NavBar.NavBarContainer;
import ngoinhacafe.GUI.NavBar.NavBarSeperator;
import ngoinhacafe.GUI.NavBar.NavBarTitle;
...
public class FormChinh extends JFrame implements MouseListener {
    ...
    public FormChinh() {
        ...
        for (int i = 0; i < navItemInfo.length; i += 4) {
            if (navItemInfo[i].equals("seperate")) {
                ...
                String chitietquyen = "qlNCC qlBanHang qlNhapHang qlHoaDon qlKhachHang qlKhuyenMai qlSanPham qlLoaiSanPham";
    ...
    public void createHeader(){
        ...
        if (true) {
            ...
            btnLogout.relocate2();
            btnLogout.setToolTipText("Đăng xuất (" + tenNhanVien + " - " + "manv" + ")");
            ...
            btnSettingUser.addMouseListener(new MouseAdapter() {
                @Override
                public void mousePressed(MouseEvent me) {
                    new DoiMatKhauForm("matk").setVisible(true);
                }
            });
