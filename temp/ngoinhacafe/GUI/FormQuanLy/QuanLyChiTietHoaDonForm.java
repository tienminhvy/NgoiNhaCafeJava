...
import ngoinhacafe.GUI.FormHienThi.HienThiChiTietHoaDon;
import ngoinhacafe.GUI.FormThemSua.ThemSuaChiTietHoaDonForm;
...
public class QuanLyChiTietHoaDonForm extends JFrame {
    ...
    public QuanLyChiTietHoaDonForm(String _mahd) {
        ...
        btnXoa.setIcon(new ImageIcon(this.getClass().getResource("/assets/images/icons8_delete_forever_30px_1.png")));
