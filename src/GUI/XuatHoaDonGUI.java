...
public class XuatHoaDonGUI extends JDialog {
    ...
    private void customEvents() {
        ...
        txtKM.getDocument().addDocumentListener(new DocumentListener() {
            public void changedUpdate(DocumentEvent e) {
                checkKhachMa();
            }
    ...
    private void checkKhachMa() {
        if (!txtTenKhach.getText().equals("") && !txtKM.getText().equals("")) {
    ...
    private void xuLyHienThiHoaDon() {
        ...
        if (timMaUI.kmTimDuoc != null) {
            int percent = 0;
            // lấy phần trăm giảm
            percent = timMaUI.kmTimDuoc.getPhanTramKM();
            if (tongTien >= timMaUI.kmTimDuoc.getDieuKien()) {
                tongTien = tongTien - (tongTien * percent / 100);
            } else {
                new CustomDialog("Không đủ điều kiện nhận ưu đãi!", CustomDialog.ERROR_DIALOG);
        ...
        hd += "<td style='text-align:center;'>" + timMaUI.kmTimDuoc.getPhanTramKM() + "%" + "</td>";
        hd += "</tr>";
        hd += "<tr>";
        hd += "<td style='text-align:center;'>" + "</td>";
        hd += "<td style='text-align:left;'>" + "</td>";
    ...
    private void initComponents() {
        ...
        btnTimKM.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnTimKM.setText("...");
        btnTimKM.setPreferredSize(new java.awt.Dimension(40, 28));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnTimKM, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(btnTimKM, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(38, 38, 38)
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (txtTenKhach.getText().equals("")) {
            new CustomDialog("Xin chọn khách hàng", CustomDialog.ERROR_DIALOG);
            return;
        }
    ...
    private void btnTimKhachActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (timKhachUI.khachHangTimDuoc != null) {
            txtTenKhach.setText(timKhachUI.khachHangTimDuoc.getMaKH() + " - " + timKhachUI.khachHangTimDuoc.getTen());
        }
    }


    private void btnTimKMActionPerformed(java.awt.event.ActionEvent evt) {
        timMaUI = new DlgKM(tongTien);
