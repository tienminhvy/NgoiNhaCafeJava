...
public class PnQuanLyNhapHangGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblKho = new CustomFunctions.Table();
        jPanel3 = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        scrTblGioNhap = new javax.swing.JScrollPane();
        tblGioNhap = new CustomFunctions.Table();
        ...
        tblPhieuNhap = new CustomFunctions.Table();
        ...
        tblCTPhieuNhap = new CustomFunctions.Table();
        ...
        if (tblKho.getColumnModel().getColumnCount() > 0) {
            ...
            tblKho.getColumnModel().getColumn(2).setResizable(false);
        ...
        if (tblGioNhap.getColumnModel().getColumnCount() > 0) {
            tblGioNhap.getColumnModel().getColumn(0).setResizable(false);
            tblGioNhap.getColumnModel().getColumn(1).setResizable(false);
            tblGioNhap.getColumnModel().getColumn(2).setResizable(false);
            tblGioNhap.getColumnModel().getColumn(3).setResizable(false);
            tblGioNhap.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        pnNhapHangLayout.setHorizontalGroup(
            ...
            .addGroup(pnNhapHangLayout.createSequentialGroup()
                .addComponent(pnTable, javax.swing.GroupLayout.PREFERRED_SIZE, 677, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        add(tabNhapHang, java.awt.BorderLayout.CENTER);
    ...
    private void tblPhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPhieuNhapMouseClicked
        ...
        txtNgayLap.setText(pn.getNgayLap());
