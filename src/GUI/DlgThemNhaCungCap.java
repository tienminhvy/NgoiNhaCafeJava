...
public class DlgThemNhaCungCap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtFax.setColumns(15);
        txtFax.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtFax.setBorder(javax.swing.BorderFactory.createTitledBorder("Fax"));
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        boolean flag = nhaCungCapBUS.themNhaCungCap(txtTenNCC.getText(), txtDiaChi.getText(), txtDienThoai.getText(), txtFax.getText());
        checkThemNCC = flag;
        if (flag) {
            this.dispose();
        }
