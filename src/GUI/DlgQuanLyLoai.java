...
public class DlgQuanLyLoai extends javax.swing.JDialog {
    ...
    DefaultTableModel dtmLoai = new DefaultTableModel();;
    ...
    private void addDTM() {
        ...
        dtmLoai.addColumn("Mô tả");
        tblLoai.setModel(dtmLoai);
        tblLoai.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        loadDataLenTblLoai();
    }
    ...
    private void initComponents() {
        ...
        tblLoai.setModel(dtmLoai);
        tblLoai.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        lblMoTa.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
    ...
    private void tblLoaiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblLoaiMouseClicked
        ...
        if (row > -1) {
            ...
            String moTa = tblLoai.getValueAt(row, 2) + "";
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (loaiBUS.suaLoai(ma, ten, moTa)) {
            loadDataLenTblLoai();
        }
    ...
    private javax.swing.JPanel pnMoTa;
