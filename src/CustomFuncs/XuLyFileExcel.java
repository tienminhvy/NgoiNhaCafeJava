...
//                contentFont.setColor(IndexedColors.BLACK.getIndex());
                ...
                new CustomDialog("Xuất file thành công!", CustomDialog.SUCCESS_DIALOG);
            }
        } catch (Exception e) {
            new CustomDialog("Xuất file thất bại!", CustomDialog.ERROR_DIALOG);
        }
    }
    ...
    public void nhapExcel(JTable tbl) {
        ...
        try {
            ...
            if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                for (int i = 1; i <= sheet.getLastRowNum(); i++) {
                    ...
                    for (int j = 0; j < row.getLastCellNum(); j++) {
                        if (dtmtbl.getColumnCount() != row.getLastCellNum()) {
                            new CustomDialog("Nhập file thất bại!", CustomDialog.ERROR_DIALOG);
                            return;
                        }
                ...
                new CustomDialog("Nhập file thành công!", CustomDialog.SUCCESS_DIALOG);
            }
        } catch (Exception e) {
            new CustomDialog("Nhập file thất bại!", CustomDialog.ERROR_DIALOG);
        }
