...
import ngoinhacafe.GUI.FormQuanLy.QuanLyChiTietPhieuNhapForm;
...
//        setDataToTable(qlpn.getDspn(), mtb);
        ...
        btnDetails.setIcon(new ImageIcon(this.getClass().getResource("/assets/images/icons8_show_property_30px.png")));
        btnRefresh.setIcon(new ImageIcon(this.getClass().getResource("/assets/images/icons8_data_backup_30px.png")));
