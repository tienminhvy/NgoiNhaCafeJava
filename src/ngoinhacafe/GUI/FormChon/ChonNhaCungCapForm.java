 ...
 */
package ngoinhacafe.GUI.FormChon;
...
public class ChonNhaCungCapForm extends JFrame {
    ...
    public ChonNhaCungCapForm(JTextField _txTarget) {
        ...
        // ======= Buttons Panel ===========
        btnCancel.setIcon(new ImageIcon(this.getClass().getResource("/assets/images/icons8_cancel_30px_1.png")));
        btnOK.setIcon(new ImageIcon(this.getClass().getResource("/assets/images/icons8_ok_30px.png")));
