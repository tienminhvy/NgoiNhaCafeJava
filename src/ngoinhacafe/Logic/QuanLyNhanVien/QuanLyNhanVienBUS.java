...
public class QuanLyNhanVienBUS {
    ...
    public void showConsole() {
        dsnv.forEach((nv) -> {
            ...
            System.out.println(nv.getMaTK() + " ");
            System.out.println(nv.getDiaChi() + " ");
            System.out.println(nv.getSDT() + " ");
            System.out.println(nv.getTrangThai());
        });
    }
       //thêm mã tài khoản
    public String[] getHeaders() {
        return new String[]{"Mã nhân viên", "Tên nhân viên", "Ngày sinh", "Mã tài khoản", "Địa chỉ", "Số điện thoại", "Trạng thái"};
    }
            ...
            if (type.equals("Tất cả")) {
                ...
                switch (type) {
                    ...
                    case "Ngày sinh":
                        ...
                        //bổ sung mã tài khoản
                    case "Mã tài khoản":
                        if (nv.getMaTK().toLowerCase().contains(value.toLowerCase())) {
                            result.add(nv);
                        }
                        break;
                        //
    ...
    public Boolean add(String manv, String tennv, LocalDate ngaysinh,String matk, String diachi, String sdt, int trangthai) {
        NhanVien nv = new NhanVien(manv, tennv, diachi, sdt, matk, ngaysinh, trangthai);
        return add(nv);
    }
