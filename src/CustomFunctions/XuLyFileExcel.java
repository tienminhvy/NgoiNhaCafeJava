    ...
    public void xuatExcel(JTable tbl) {
        ...
        try {
            ...
            if (chooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                new Dialog("Xuất file thành công!", Dialog.SUCCESS_DIALOG);
            }
        } catch (Exception e) {
            new Dialog("Xuất file thất bại!", Dialog.ERROR_DIALOG);
        }
    }
    ...
    public void nhapExcel(JTable tbl) {
        ...
        try {
            ...
            if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                new Dialog("Nhập file thành công!", Dialog.SUCCESS_DIALOG);
            }
        } catch (Exception e) {
            new Dialog("Nhập file thất bại!", Dialog.ERROR_DIALOG);
        }
